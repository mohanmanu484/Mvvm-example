...
import com.example.mohang.mvvmproject.BR;
...
public class MyAdapter<T> extends BaseAdapter {
    ...
    private MyAdapter(int layout, List<T> listItems, ActionHandler actionHandler, ViewListener viewListener, RecyclerConfiguration recyclerConfiguration) {
        this.listItems = listItems;
        this.layout = layout;
    ...
    private MyAdapter(ViewTypeHandler viewTypeHandler, List<T> listItems, ActionHandler actionHandler, ViewListener viewListener, RecyclerConfiguration recyclerConfiguration) {
        this.actionHandler = actionHandler;
        this.listItems = listItems;
    ...
    public static class Builder<T> {
        ...
        public MyAdapter<T> build() {
            ...
            if (viewTypeHandler == null) {
                return new MyAdapter<T>(layoutRes, list, actionHandler,viewListener,recyclerConfiguration);
            }

            return new MyAdapter<T>(viewTypeHandler, list, actionHandler,viewListener,recyclerConfiguration);
        }
